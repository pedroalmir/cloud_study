...
mkdir -p ssn-docker/volumes/frontend
...
wget --no-check-certificate 'https://docs.google.com/uc?export=download&id=1yUy4sINTdj9UqYDiCu94WExU1nDB842C' -O ssn-docker/volumes/frontend/frontend.zip
unzip ssn-docker/volumes/frontend/frontend.zip